const funBits = [
	...
	'One of my cats, Tapi, fell (jumped, the little devil) from the 9th floor of the building I used to live. She didn’t break a single bone, but was hospitalised for two days!',
